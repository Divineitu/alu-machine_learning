#!/usr/bin/env python3
"""Defines a deep neural network with selectable hidden activation."""
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers, activation='sig'):
        """Initialize the network with nx features, layer sizes, activation."""
    ...
    @property
    def activation(self):
        """Return the hidden layer activation function name."""
    ...
    def cost(self, Y, A):
        """Calculate the categorical cross-entropy cost of the model."""
        m = Y.shape[1]
        ...
        for i in range(self.__L, 0, -1):
            ...
            if i > 1:
                if self.__activation == 'sig':
                    ...
                    deriv = 1 - A_prev ** 2
                dz = np.matmul(weights['W' + str(i)].T, dz) * deriv
